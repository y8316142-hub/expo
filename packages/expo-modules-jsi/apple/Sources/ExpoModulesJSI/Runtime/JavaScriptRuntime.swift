...
open class JavaScriptRuntime: Equatable, @unchecked Sendable {
  ...
  /// the JS pthread but where `NSThread.current.name` may not be set (e.g. React Native
  /// Fabric's props-parsing path). Traps if not actually on the JavaScript thread.
