...
extension Data: JavaScriptCodable {
  @JavaScriptActor
  @inlinable
  public static func decode(_ value: JavaScriptValue, appContext: AppContext, runtime: borrowing JavaScriptRuntime) throws -> Data {
  ...
  @JavaScriptActor
  @inlinable
  public static func encode(_ value: Data, appContext: AppContext, runtime: borrowing JavaScriptRuntime) throws -> JavaScriptValue {
