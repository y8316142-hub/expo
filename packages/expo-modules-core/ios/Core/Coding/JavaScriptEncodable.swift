...
/// See `JavaScriptDecodable` for why `runtime` is `borrowing` and `appContext` is not.
public protocol JavaScriptEncodable {
  @JavaScriptActor
  static func encode(_ value: Self, appContext: AppContext, runtime: borrowing JavaScriptRuntime) throws -> JavaScriptValue
}
