...
extension Enumerable where Self: RawRepresentable, RawValue: JavaScriptCodable {
  @JavaScriptActor
  @inlinable
  public static func decode(_ value: JavaScriptValue, appContext: AppContext, runtime: borrowing JavaScriptRuntime) throws -> Self {
  ...
  @JavaScriptActor
  @inlinable
  public static func encode(_ value: Self, appContext: AppContext, runtime: borrowing JavaScriptRuntime) throws -> JavaScriptValue {
